...
<div id="<?php echo $id; ?>" class="optin-box optin-box-28"<?php echo $style_str; ?>>
    <div class="optin-box-content">
        ...
        <?php
        $privacyImage = '<img src="'.OPPP_BASE_URL.'images/elements/optin_box/optin-28-privacy.png" alt="' . __('privacy','optimizepress-plus-pack') . '" width="11" height="14" /> ';
