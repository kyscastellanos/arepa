                ...
                <div class="main-content-area">
                    ...
                    <div class="featured-posts cf">
                        ...
                        <div class="post-content-container">
                            ...
                            <div class="post-content cf<?php echo $has_img ? '':' no-post-image' ?>">
                                <?php if($has_img): ?>
                                <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'optimizepress'), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" class="post-image"><?php the_post_thumbnail( 'featured-post' ); ?></a>
                                <?php endif ?>
                                <h2><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'optimizepress'), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
                                <?php the_excerpt() ?>
                                <?php op_post_meta() ?>
                    ...
                    foreach ($postslist->posts as $post) :  setup_postdata($post); ?>
                        ...
                        <div class="older-post<?php echo $class ?>">
                            ...
                            <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'optimizepress'), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" class="post-image"><?php the_post_thumbnail( 'list-image' ); ?></a>
                        <?php endif ?>
                            <?php echo $image ?>
