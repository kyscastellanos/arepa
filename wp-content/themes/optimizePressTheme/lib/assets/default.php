    ...
    */
    static function _asset_list()
    {
        $assets_array = array(
            ...
            'recent_posts' => __('Recent Posts', 'optimizepress'),
...
<li>
    ...
    static function recent_posts($atts){
        ...
        foreach( $recent_posts as $recent ){
            ...
            if ($style == 9) {
                $recent_html .= '<p class="description">' . substr($recent['post_content'], 0, 100) . ' [...]</p>';
                $recent_html .= '<a class="read-more" href="'.get_permalink($recent["ID"]).'">Read more</a>';
            }
            $recent_html .= '</div>
                </li>';
        }
...
';
    ...
    static function set_lang_keys(){
        self::$lang_keys = array(
            ...
            'recent_posts_description' => __('Insert a list of the most recent posts from your blog. Perfect for creating a custom home page.', 'optimizepress'),
