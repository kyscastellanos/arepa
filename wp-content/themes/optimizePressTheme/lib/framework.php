    ...
    */
    ...
    function compatibilityCheck()
    {
        if (version_compare(PHP_VERSION, '5.3', '<')) {
            echo '<div class="update-nag">' . sprintf(__('Your PHP version (%s) is lower than recommended (%s) by OptimizePress and therefore some features might not work. <a href="%s">Check compatibility</a>.', 'optimizepress'), PHP_VERSION, '5.3', admin_url('admin.php?page=optimizepress#global_settings--compatibility_check')) . '</div>';
        }
    }
